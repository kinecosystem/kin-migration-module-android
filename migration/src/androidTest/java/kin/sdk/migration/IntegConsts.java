...
final class IntegConsts {
    ...
    static final String TEST_SDK_URL_CREATE_ACCOUNT = "http://friendbot-testnet.kininfrastructure.com?addr=%s&amount=" + 0; // zero because the default is currently 10000
