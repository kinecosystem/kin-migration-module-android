...
final class IntegConsts {
    ...
    static final String TEST_SDK_URL_CREATE_ACCOUNT = "http://10.0.2.2:8000?addr=%s&amount=" + 0;
    static final String TEST_SDK_NETWORK_ID = "Kin Testnet ; December 2018";
    static final String TEST_SDK_URL_FUND = "http://10.0.2.2:8000/fund?addr=%s&amount=";
    ...
    static final String TEST_CORE_URL_FUND = "http://faucet-playground.kininfrastructure.com/fund?account=%s&amount="; // faucet
